import './styles.css';
import snowwolf from '/home/mcantek/projects/fork/pomeranian-bolierplate-public/src/App/Images/snow-wolf.png';

const FigmaFloatDesign = () => {
  return (
    <>
      <div className="floatExcercise">
        &lt; BLOG &lt; ĆWICZENIE
        <p>
          {' '}
        ...
        <div className="pink-bgc">
          <img src={snowwolf} alt="snow fox" />
          Lorem Ipsum is simply dummy text of the printing and typesetting
          industry. Lorem Ipsum has been the industry's standard dummy text ever
          since the 1500s, when an unknown printer took a galley of type and
          scrambled it to make a type specimen book.
        </div>
        <div className="dark-bgc">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
          eiusmod tempor incididunt ut labore et dolore magna aliqua. Nibh
          mauris cursus mattis molestiea iaculis at. Dictum varius duis at
          consectetur lorem donec.{' '}
        </div>
        <button>zapisz na poźniej</button>
